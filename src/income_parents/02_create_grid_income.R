...
# Predictors
income_groups    <- c("all", "Low", "Mid", "High")
gender_groups    <- c("all", "Mannen", "Vrouwen")
migration_groups <- c("all", "Marokko", "Nederland", "Nederlandse Antillen (oud)",
                      "Overig", "Suriname", "Turkije")
household_groups <- c("all", "two parents", "single parent")
